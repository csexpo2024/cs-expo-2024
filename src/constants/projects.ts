...
export const projects: Record<string, Project> = {
    ...
    "meowtion": {
        ...
        group: "Algoriteam",
        groupid: "algoriteam",
        description: "The rising trend of cat ownership in the Philippines highlights the urgent need for effective pet monitoring solutions. Traditional methods, such as CCTV cameras, often fall short, as they require time-consuming manual observation and fail to provide detailed behavioral insights, particularly regarding separation anxiety and overall well-being. The mobile application \"Meowtion Capture\" has been developed to offer cat owners real-time, detailed reports on five specific behaviors: sitting, standing, lying down, vomiting, and eating. Additionally, it provides first-aid instructions when abnormal behaviors are detected, ensuring timely interventions. The application employs Convolutional Neural Networks (CNN) and You Only Look Once (YOLO) for real-time video processing and behavior analysis, significantly enhancing the accuracy of existing monitoring solutions. The YOLOv8 model was trained and tested, and the application's performance was assessed through a comprehensive survey conducted with 37 participants, including 30 pet owners, 3 veterinarians, and 4 CS/IT professionals. Adhering to ISO 25010 standards, the mobile application achieved an overall average score of 3.82 out of 4.00 across all categories assessed by the developers. This rating indicates that the participants strongly agree with the application's effectiveness. Future research should focus on optimizing performance, reliability, and user experience in feline behavioral analysis. Additionally, it is recommended that investigations explore advanced algorithms, robust error handling, intuitive backup solutions, and the integration of AI-driven features, while also expanding compatibility across platforms and considering applications for other animals and health monitoring.",
    ...
    "mlfds": {
        ...
        group: "Chilimansi",
        groupid: "chilimansi",
        description: "The Multi-Layered Fraud Detection System (MLFDS) is a comprehensive approach to combating fraud, utilizing a combination of machine learning and natural language processing techniques. It has been validated by cybersecurity professionals who commended its potential real-world impact and high accuracy. The MLFDS effectively addresses the challenges of fraud detection, offering a promising solution for businesses across industries. While the system has shown great promise, recommendations for further improvement include model optimization, enhanced alerting mechanisms, real-time monitoring, additional data validation, and implementation of robust data privacy measures. By incorporating these recommendations, the MLFDS can be further strengthened and its real-world impact maximized, providing businesses with a powerful tool to proactively identify and mitigate fraudulent activity.",
    ...
    "tala": {
        ...
        group: "Codex",
        groupid: "codex",
        description: "The integration of AI technologies into everyday applications is revolutionizing time management for students by enhancing efficiency and productivity. This study focuses on the development and evaluation of Tala, an AI-powered calendar designed to address the common scheduling challenges faced by students. Utilizing a mixed-methods approach, this research uses quantitative surveys like Likert scale assessments with feedback from key stakeholders, including College Students from FEU Tech and CS Professionals. The research adheres to the ISO 25010 Standard criteria to evaluate user satisfaction, functionality, and usability. Results from the survey indicate that Tala significantly reduces problems encountered by students with time management like lack of motivation, distractions, and inconsistency, and increases productivity, receiving positive feedback for its intuitive interface and intelligent features. The study underscores the potential of AI-driven tools to revolutionize traditional scheduling methods, offering insights into their implementation and future enhancements. This paper aims to contribute to the broader discourse on AI applications in educational settings, demonstrating how advanced technology can meet diverse stakeholder needs and improve overall time management practices for students.",
    ...
    "csgo": {
        ...
        groupid: "csgo",
        description: "This thesis presents an automated congestion pricing system tested on major highways in Manila, utilizing image processing, YOLO object detection, and Claude 3.5 Sonnet for license plate extraction. The system supports the Congestion Pricing Policy by detecting vehicles via CCTV, classifying them, and charging based on user-defined rates when they enter congested zones. It also adapts to low light and foggy conditions using an Image-Adaptive framework, achieving an mAP of 90.03%. YOLOv8n was selected for its efficiency, with an mAP of 81.80% at 50% IOU and a 66% F1 score at 35.6% confidence. Testing results showed an average accuracy of 75.34%, with strong user and expert evaluations.",
    ...
    "mimical": {
        ...
        description: "The advent of improved machine learning algorithms, and specialized deep learning hardware and neural networks have significantly enhanced computer-generated content including Voice Synthesis(VS) and Voice Modification(VM). The techniques have grown in sophistication and ubiquity over the last few years. Some computer-generated voices are so sophisticated that they are almost indistinguishable from a human voice if one isn’t paying attention. To combat the growing risk posed by such techniques growing unchecked, this study aims to solve the problem of voice modification detection. This study determines the best method to determine audio traits using machine learning and deep learning algorithms. These algorithms are then compared to determine which algorithm is the most capable and efficient in the job of defining and classifying the authenticity of voice audio. Using the most optimal algorithm, the researchers achieved an overall accuracy rating of 86.40%, a precision rating of 86.21%, a recall rate of 90.07%, and an overall F1 score of 88.10%. Finally, the researchers implemented the algorithm into a system for public use.",
    ...
    "ensys-chat": {
        ...
        group: "Ensys",
        groupid: "ensys",
        description: "This study delves into the development of an empathic AI chatbot named \"EnSys\" for the customer service sector, focusing on applications within the food and service industry. The primary reason for conducting this is to address the limitations of existing chatbots in engaging empathetically with users, thereby enhancing customer satisfaction and operational efficiency. The key problems this work attempts to solve include delayed response times to customer complaints, limited documentation of feedback, insufficient follow-up mechanisms, and other customer service challenges tackled in the study. In addressing these issues, the study leverages the latest technologies such as natural language processing (NLP), sentiment analysis, and empathic computing, with the assistance of OpenAI. Key components include linguistic processing techniques, sentiment assessment, and empathic design principles, empowering the chatbot to understand and respond effectively to human emotions. The methodologies employed encompass alpha testing, black box testing, and performance evaluation based on ISO 25010 standards. The results show that the model achieved high accuracy and performance metrics through an F1 score of 80.09%, reflecting its effectiveness in understanding and responding to customer emotions. Additionally, post-survey results indicated high user ratings for functionality (4.70), usability (4.74), performance (4.81), and supportability (4.72). Ultimately, the integration of empathic AI chatbots in the food services industry offers a viable solution to current feedback management challenges, providing businesses with a competitive edge through improved customer interactions and operational effectiveness. This research underscores the potential of AI-driven customer service in fostering more empathetic and efficient engagements.",
    ...
    "book-i": {
        ...
        description: "In today's rapidly evolving business landscape, effective appointment and reservation management is essential for operational efficiency and customer satisfaction. This study introduces Book-I, an advanced automated online booking system available as both a mobile and web application designed to enhance scheduling processes for diverse industries by leveraging artificial intelligence (AI). Book-I replaces traditional manual booking methods, addressing common issues such as scheduling conflicts and inefficiencies, and offers personalized appointment date recommendations based on users' past interactions. The system also features a chatbot powered by Natural Language Processing (NLP) to facilitate seamless and intuitive appointment bookings. The research involved feedback from 40 respondents, including dental clinic owners, hair salon and barbershop owners, business administrators, receptionists, general users, and IT experts. Their insights were instrumental in shaping the system's development to meet industry-specific needs and improve overall user experience. The evaluation of Book-I through the FURPS (Functionality, Usability, Reliability, Performance, and Security) framework yielded an overall average score of 4.32 (Strongly Agree) from business owners, administrators, receptionists, and IT experts regarding the web application. Meanwhile, the mobile application received an average score of 4.17 (Agree) from general users and IT experts. Book-I represents a significant advancement in automated scheduling solutions, offering a powerful tool for SMEs across various sectors. By integrating advanced AI features and focusing on user-centric design, Book-I aims to streamline appointment management, reduce scheduling time, and provide a highly adaptive and efficient solution for modern businesses.",

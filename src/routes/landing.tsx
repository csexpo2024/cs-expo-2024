...
const Landing = () => {
  ...
  const heroBgY = useTransform(heroYProgress, [0, 1], ["0%", "110%"]);

  const magnifyingGlassX = useTransform(heroYProgress, [0, 1], ["1%", "300%"]);
  ...
  const eventsBgY = useTransform(eventsYProgress, [0, 1], ["1%", "100%"]);
  ...
  return (
    <>
      ...
      >
        <section className="flex flex-col gap-5 justify-center items-center py-16 lg:px-24 pt-[20vh] min-h-screen sticky top-0 overflow-hidden">
